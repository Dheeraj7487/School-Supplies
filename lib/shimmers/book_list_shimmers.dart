              ...
              child: Card(
                ...
                child: Container(
                  decoration: BoxDecoration(
                      ...
                      border: Border.all(width: 0.5,color: AppColor.darkWhiteColor)
                  ),
                  child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children:  const [
                                  Text('', style: TextStyle(color: AppColor.darkWhiteColor,fontSize: 16),maxLines: 1,overflow: TextOverflow.ellipsis),
                                  SizedBox(height: 5),
