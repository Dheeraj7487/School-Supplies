      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            StreamBuilder(
              stream: FirebaseCollection().userRatingCollection
                  .where('bookName', isEqualTo: widget.snapshotData['bookName']).snapshots(),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text('${snapshot.data?.docs[index]['userName']}',style: Theme.of(context).textTheme.headline5,),
                                    const SizedBox(
                                      height: 5,
                                    ),
                                    RatingBar.builder(
                                    ...
                                    Text('${snapshot.data?.docs[index]['userGiveExprience']}',
